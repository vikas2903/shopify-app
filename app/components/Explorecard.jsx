            ...
            <div className="img-bottom">
              <div className="imgb-l">
                ...
                <span className="cta-image">
                  ...
                  <span onClick={() =>{window.open(`https://d2c-apps.myshopify.com/admin/themes/173246185506/editor?context=sections&template=product`, '_blank');}} className="unicode">+</span>
                 */} 
                </span>
             ...
             <InlineStack  wrap spacing="400" style='var(--p-space-200)'>  
                  ...
                  <Button  variant="secondary" size="large" onClick={()=>{ window.open(`https://d2c-apps.myshopify.com/`, '_blank');}} icon={ExternalIcon} accessibilityLabel="Open in new tab" />  &nbsp; 
